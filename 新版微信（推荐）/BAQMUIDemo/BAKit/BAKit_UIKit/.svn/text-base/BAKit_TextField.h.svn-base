...
/*! BAKit_TextField 样式枚举 */
typedef NS_ENUM(NSInteger, BAKit_TextFieldStyle) {
    /*! 默认 */
    BAKit_TextFieldStyleNone,
    /*! 手机号码格式化 【格式化结果：138 1111 1111】 */
    BAKit_TextFieldStylePhone,
    /*! 银行卡卡号格式化【格式化结果：1111 1111 1111 1234】 */
    BAKit_TextFieldStyleBank
};

@interface BAKit_TextField : UITextField

/*! textfiled 输入的格式化格式 有四种 */
@property (nonatomic) BAKit_TextFieldStyle textfieldStyle;
