...
/**
 定位中
 */
typedef void (^BALocation_locatingBlock)();

/**
 获取当前位置

 @param place CLPlacemark
 */
typedef void (^BALocation_getCurrentLocationBlock)(CLPlacemark *place);
 ...
 */
typedef void (^BALocation_refuseToUsePositioningSystemBlock)(NSString *message);
...
/**
 ...
 @param message message description
 */
typedef void (^BALocation_locateFailureBlock)(NSString *message);
