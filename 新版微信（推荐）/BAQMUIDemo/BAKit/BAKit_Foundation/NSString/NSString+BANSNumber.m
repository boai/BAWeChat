...
#pragma mark - ***** 格式化为货币样式，输出结果示例：numberFormatter == ¥12,345,678.89
+ (NSString *)ba_stringFormatterWithChineseCurrencyStyleWithNumberString:(NSString *)numberString
{
//    NSNumberFormatter *numberFormatter = [[NSNumberFormatter alloc] init];
//    [numberFormatter setPositiveFormat:@"¥ ###,###.##"];
//    NSString *formattedNumberString = [numberFormatter stringFromNumber:[NSNumber numberWithFloat:number]];
//    
