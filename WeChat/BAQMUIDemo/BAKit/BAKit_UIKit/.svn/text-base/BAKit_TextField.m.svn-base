...
@interface BAKit_TextField () <UITextFieldDelegate>

@end

@implementation BAKit_TextField
...
- (void)setTextfieldStyle:(BAKit_TextFieldStyle)textfieldStyle
{
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    ...
    if (self.phoneRestrict || self.verCodeRestrict)
    {
        ...
        {
            if (_textfieldStyle == BAKit_TextFieldStylePhone)
            {
    ...
    if (self.numberRestrict)
    {
        for (NSInteger loopIndex = 0; loopIndex < lengthOfString; loopIndex++)
        {
            ...
            else
            {
                ...
                if (_textfieldStyle == BAKit_TextFieldStyleBank)
                {
