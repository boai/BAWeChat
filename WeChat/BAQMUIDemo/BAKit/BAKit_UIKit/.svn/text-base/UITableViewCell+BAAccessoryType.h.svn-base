...
typedef NS_ENUM(NSInteger, BATableViewCellAccessoryType)
{
    BATableViewCellAccessoryNone,
    BATableViewCellAccessoryDisclosureIndicator,
    BATableViewCellAccessorySwitch
};

@interface UITableViewCell (BAAccessoryType)
//normal
