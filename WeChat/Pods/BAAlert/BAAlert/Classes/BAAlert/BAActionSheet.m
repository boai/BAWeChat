...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.actionSheetType == BAActionSheetTypeCustom)
    {
        ...
        {
            cell.textLabel.text = NSLocalizedString(@"取 消", @"取 消");
        }
...
//        imageName = @"BAAlert.bundle/Images/arow_down";
        ...
        NSBundle *bundle;
        bundle = [NSBundle ba_bundleWithBundleName:@"BAAlert" podName:@"BAAlert"];

        NSAssert(bundle, @"bundle 资源加载失败！");
        UIImage *image;
//        image = [UIImage imageNamed:@"arow_down"];
        image = [UIImage imageNamed:@"arow_down" inBundle:bundle compatibleWithTraitCollection:nil];
